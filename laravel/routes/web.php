...
Route::get('hook/create/{unknown_hook_id}', 'HookController@createPage')->name('hook.create-page');
Route::post('hook/create', 'HookController@create')->name('hook.create');
Route::any('hook', 'HookController@detector')->name('hook');
Route::get('hook/id/{hook_id}', 'HookController@detail')->name('hook.detail');
Route::match(['get', 'post'], 'hook/{hook_id}/edit', 'HookController@edit')->name('hook.edit');
Route::get('hook/delete-page/{hook_id}','HookController@deletePage')->name('hook.delete-page');
Route::delete('hook/delete/{hook_id}','HookController@delete')->name('hook.delete');
Route::put('hook/active/{hook_id}','HookController@active')->name('hook.active');
Route::put('hook/de-active/{hook_id}','HookController@deActive')->name('hook.de-active');
